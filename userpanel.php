    ...
    if (isset ($_SESSION['userId'])) {
        ...
        if ($user != null) {
            ...
            <form action="updateUser.php" method="post">
                ...
                <b><input type="checkbox" name="changePassword" id="changePassword"></checkbox>Password change:</b><br>
                Old password:<input class="password" readonly="readonly" type="password" name="oldPassword" id="oldPassword"></input><br>
                New password:<input class="password" readonly="readonly" type="password" name="newPassword1" id="newPassword1"></input><br>
                Confirm new password:<input class="password" readonly="readonly" type="password" name="newPassword2" id="newPassword2"></input><br>
